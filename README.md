...
- [DNSControl](https://stackexchange.github.io/dnscontrol/) - 使用简单 DSL 同步多个提供商的 DNS。 ([源代码](https://github.com/StackExchange/dnscontrol)) `MIT` `Go/Docker`
...
- [Briefkasten](https://github.com/ndom91/briefkasten) - 一款用于保存和管理个人书签的现代应用程序，包含浏览器扩展。 ([演示](https://briefkastenhq.com/auth/signin)) `MIT` `Node.js/Docker`
...
- [Grimoire](https://grimoire.pro) - 带有现代 UI 的书签管理器，具备自动内容和元数据提取、分类、过滤等功能。完全文档化的 REST API，并提供 Docker 镜像，便于部署。 ([源代码](https://github.com/goniszewski/grimoire)) `MIT` `Node.js/Docker`
...
- [txtdot](https://tempoworks.github.io/documentation) - 仅解析页面中的文本、链接和图片的 HTTP 代理，减少带宽占用，去除广告和繁重脚本。 ([演示](https://txt.dc09.ru), [源代码](https://github.com/TempoWorks/txtdot)) `MIT` `Node.js/Docker`
...
- [Focalboard](https://www.focalboard.com/) - 定义、组织、追踪和管理个人和团队工作（Trello、Notion 和 Asana 的替代品）。 ([源代码](https://github.com/mattermost-community/focalboard), [客户端](https://www.focalboard.com/download/personal-edition/desktop/)) `MIT/AGPL-3.0/Apache-2.0` `Node.js/Go/Docker`
...
- [Etherpad](https://etherpad.org/) - 高度可定制的在线编辑器，支持实时协作编辑。 ([演示](https://demo.sandstorm.io/appdemo/h37dm17aa89yrd8zuqpdn36p6zntumtv08fjpu8a8zrte7q1cn60), [源代码](https://github.com/ether/etherpad-lite)) `Apache-2.0` `Node.js/Docker`
...
- [Spooty](https://github.com/Raiper34/spooty) `⚠` - 从 Spotify 下载曲目、播放列表和专辑，并可订阅播放列表或作者页面，在有新歌发布时自动下载。 `MIT` `Docker/Node.js`
...
- [Libredesk](https://libredesk.io/) - 现代化客户支持工单系统，单二进制文件应用。 ([源代码](https://github.com/abhinavxd/libredesk)) `AGPL-3.0` `Docker/Go/Node.js`
...
- [tito](https://github.com/dgoodwin/tito) - 为基于 git 的项目构建 RPM 包。 ([源代码](ttps://github.com/dgoodwin/tito)) `GPL-2.0` `Python`
...
- [Statsd](https://github.com/etsy/statsd/) - 监听计数器、定时器等统计信息的守护进程，通过 UDP 或 TCP 接收并聚合后发送到后端服务。 `MIT` `Node.js`
...
- [etcd](https://etcd.io/) - 分布式 K/V 存储，通过 SSL PKI 认证和 REST HTTP API 提供共享配置与服务发现。 ([源代码](https://github.com/coreos/etcd)) `Apache-2.0` `Go`
...
- [Word Mastermind](https://github.com/clupasq/word-mastermind) - Wordle克隆。类似猜谜游戏Mastermind，但你需要猜测单词而不是颜色。 ([演示](https://word-mastermind.glitch.me/)) `MIT` `Node.js`
...
- [Linux Dash](https://github.com/afaqurk/linux-dash) - 针对 GNU/Linux 机器的低开销 Web 监控仪表盘。 `MIT` `Node.js/Go/Python/PHP`
...
- [LXD](https://linuxcontainers.org/lxd/) - 容器“管理器”，为 LXC 提供更好的用户体验。 ([源代码](https://github.com/lxc/lxd)) `Apache-2.0` `Go`
...
- [Mergeable](https://www.usemergeable.dev) `⚠` - 更好用的 GitHub Pull Request 收件箱。 ([演示](https://app.usemergeable.dev), [源代码](https://github.com/pvcnt/mergeable)) `MIT` `Node.js/Docker/K8S`
...
- [Tailchat](https://tailchat.msgbyte.com/) - 下一代 noIM 应用，位于您自己的工作空间，不仅仅是另一个 Slack/Discord/rocket.chat。 ([演示](https://nightly.paw.msgbyte.com/), [源代码](https://github.com/msgbyte/tailchat)) `Apache-2.0` `Docker/K8S/Node.js`
...
- [Cal.com](https://cal.com/) - 在线预约调度系统。 ([演示](https://app.cal.com/bailey), [源代码](https://github.com/calcom/cal.com)) `AGPL-3.0` `Node.js`
